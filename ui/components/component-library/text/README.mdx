...
Use the `as` (fka Tag) prop to change the root html element of the Typography component
...
Use any valid box props [Box](/?path=/story/ui-components-ui-box-box-stories-js--default-story) component props to the Typography component. `boxProps` will overwrite the `margin` prop
